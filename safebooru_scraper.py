...
class Kurumi:
    ...
    def __init__ (self, root):
        ...
        self.tags_label = tkinter.Text(self.root, font = "Helvetica, 10",
                                       bg = "#F0F0ED")
        self.copy_button = tkinter.Button(self.root, text = "Copy Image Link", 
                                          command = self.copy_image_link)
    ...
    def update_search(self, event):
        ...
        self.search_tags = self.search_bar.get()
        self.page_num = 0
        self.counter = 0
        self.safebooru_link = "https://safebooru.org/index.php?page=post&s=list&tags="
        self.start()
    ...
    def right_key (self, event):
        ...
        if self.counter == len(self.thumbnails) - 1 and len(self.thumbnails) < 40:
            ...
            print("Last image!")
            return
        if self.counter == len(self.thumbnails):
            self.page_num += 1
            self.generate_link()
            self.get_thumbnails()
        else:
    ...
    def generate_link (self):
        '''generates the proper safebooru link'''
    ...
    def display_image(self):
        ...
        try:
            ...
            imagelink = "https://safebooru.org/" + self.thumbnails[self.counter].find("a")["href"]
